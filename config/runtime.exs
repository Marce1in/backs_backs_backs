...
#
#     PHX_SERVER=true bin/backs_backs_backs start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :backs_backs_backs, BacksBacksBacksWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /data/backs_backs_backs_prod.db
      """
  ...
  config :backs_backs_backs, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :backs_backs_backs, BacksBacksBacks.Mailer,
