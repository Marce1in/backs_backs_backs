defmodule BacksBacksBacksWeb.Router do
  use BacksBacksBacksWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BacksBacksBacksWeb.Layouts, :root}
  ...
  if Application.compile_env(:backs_backs_backs, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BacksBacksBacksWeb.Telemetry
